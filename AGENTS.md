# AGENTS.md - CanalBox SDK Developer Guide
...
- Include all required headers for Salesforce: Origin, Referer, Content-Type
- Use raw Cookie header string for critical session cookies
